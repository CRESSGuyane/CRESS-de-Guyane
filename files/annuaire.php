<?php 
    ...
    if( isset( $_GET['domaine'])|| isset( $_GET['statut'])||isset( $_GET['query'])){
        ...
        $liste_structures = filtres($filtreStatut,$filtreDomaine,$filtreRecherche);
        $seleted = "";
    ...
    <div class="page-wrapper">
        ...
        <section class="event-page">
            ...
            <form class="form-group">
                ...
                ?>
                <a href="http://127.0.0.1/CRESS-webproject/files/structure.php?id=<?php echo $structure['id'] ; ?>">
                ...
                <div class="text-center more-post__btn">
                    <a href="#" class="thm-btn">Voir plus</a>
                </div><!-- /.text-center -->
            </div>
        </section>
        <!--Event Page End-->
